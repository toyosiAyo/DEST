...
<head>
    ...
    <script src="https://kit.fontawesome.com/1522f4a43a.js" crossorigin="anonymous"></script>
    <!--<![endif]-->
    <style>
        * {
            ...
            <tr>
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: white;" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                            ...
                                            <tr>
                                                <td class="column"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                style="padding-bottom:10px;width:100%;padding-right:0px;padding-left:0px;margin-top:60px;">
                                                                <div align="center" style="line-height:10px"><img
                                                                        alt=""
                                                                        src="https://dest.run.edu.ng/img/Runny.png"
                            ...
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column" 0pt; mso-table-rspace: 0pt; font-weight: 400;
                                                    text-align: left; vertical-align: top; padding-top: 5px;
                                                    padding-bottom: 0px; border-top: 0px; border-right: 0px;
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td style="text-align:center;width:100%;">
                                                                <h1
                                                                    style="margin: 0; color: #110658; direction: ltr; font-family: Tahoma, Verdana, Segoe, sans-serif; font-size: 25px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;">
                                                                    <strong></strong>
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div
                                                                        style=" box-shadow: inset; padding:20px; font-size: 12px; font-family: Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px; color: #393d47; line-height: 1.5;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center; padding: 10px; mso-line-height-alt: 21px;">
                                                                            <span style="font-size:14px;">
                                                                                <div
                                                                                    style="font-size: 14px; color: #666D71;">
                                                                                    Dear {{ $data['name'] }}</div>
                                                                                <br>
                                                                                ...
                                                                                <br>
                                                                                <div
                                                                                    style="font-size: 14px; color: #2AAE74;">
                                                                                    DEST Admin,<br>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:10px;"> If you have
                                                                                any problems</span><br /><span
                                                                                style="font-size:10px;">please contact
                                                                                us at <a
                                                                                    href="mailto:info.dest@run.edu.ng"
                                                                                    rel="noopener"
                                                                                    style="text-decoration: underline; color: #393d47;"
                                                                                    title="info.dest@run.edu.ng">info.dest@run.edu.ng</a>
                                                                                or call us at +2348150465869 </span>
                                                                        </p>
                                                                        <div
                                                                            style="display: flex; justify-content: space-between; margin-top: 20px;">
                                                                            <div><a
                                                                                    href="https://www.twitter.com/RedeemersUni"><img
                                                                                        src="https://transcriptapp.run.edu.ng/images/twitter2x.png"
                                                                                        alt=""
                                                                                        width="40px"></a></div>
                                                                            <div><a
                                                                                    href="https://www.instagram.com/redeemersuniversity"><img
                                                                                        src="https://transcriptapp.run.edu.ng/images/instagram2x.png"
                                                                                        alt=""
                                                                                        width="40px"></a></div>
                                                                            <div><a
                                                                                    href="https://www.linkedin.com/school/redeemersuniversity"><img
                                                                                        src="https://transcriptapp.run.edu.ng/images/linkedin2x.png"
                                                                                        alt=""
                                                                                        width="40px"></a></div>
                                                                            <div><a
                                                                                    href="https://www.facebook.com/redeemersuniversity"><img
                                                                                        src="https://transcriptapp.run.edu.ng/images/facebook2x.png"
                                                                                        alt=""
                                                                                        width="40px"></a></div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="banner">
                                                                        <img src="https://transcriptapp.run.edu.ng/images/banner.png"
                                                                            alt=""
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column"
                                                    ...
                                                    width="100%">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        class="html_block" role="presentation"
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                                                        width="100%">
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 0; text-align: center;">
                                                                            Copyright © 2025 RUNDEST. All rights
                                                                            reserved.<a href="https://dest.edu.ng"
                                                                                style=""></a></p>
                                                                        <p
