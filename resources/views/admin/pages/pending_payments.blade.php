            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Pending Payments</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <h5 class="card-title">Pending Payment history <span class="text-muted fw-normal ms-2">({{$count}})</span></h5>
                            </div>
                        </div>
                    </div>
                    <!-- end row -->
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><button data-pay_type="{{$payment->pay_type}}" data-id="{{$payment->id}}" data-rrr="{{$payment->rrr}}" data-email="{{$payment->email}}" class="dropdown-item approve" href="#">Approve</button></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>   
