...
@section('content')
    ...
    <body class="animsition page-faq site-menubar-push site-menubar-open site-menubar-fixed">
                            ...
                            <div class="panel-body">
                                <div class="list-group faq-list" role="tablist">
                                    <a class="list-group-item active" data-toggle="tab" href="#category-1"
                                        aria-controls="category-1" role="tab">Foundation</a>
                                    ...
                                    <a class="list-group-item" data-toggle="tab" href="#category-3"
                                        aria-controls="category-3" role="tab">Part-Time</a>
                                </div>
                            </div>
                        </div>
                        <!-- End Panel -->
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="animation-example animation-hover hover">
                                                            <button type="submit" data-surname="{{ $data->surname }}"
                                                                ...
                                                                data-paytype="foundation"
                                                                class="btn btn-dark animation-scale-up pay">Create
                                                                Application </button>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <!-- Modal -->
        <div class="modal fade modal-newspaper" id="modal_teller" aria-hidden="true" aria-labelledby="exampleModalTitle"
                ...
                <div class="modal-content">
                    ...
                    <form method="post" id="form_teller">
                        ...
                        <div class="modal-body">
                            <p>Pay the sum of ₦<span id="show_amount"></span> to (<span id="show_account"></span>) and
                                enter Teller number here</p>
