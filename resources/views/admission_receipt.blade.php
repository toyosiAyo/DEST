        ...
        <tr>
            <td>
                <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td colspan="3" align="left"><img src="{{ asset('assets/images/runny.png') }}"
                                width="500" height="120" /></td>
                    </tr>
                    <tr>
                        <td colspan="3" align="center">
                            <table width="100%" cellspacing="0" cellpadding="5" class="course_reg" border="0">
                                <tr>
                                        ...
                                        <table width="95%" border="0" align="center" cellpadding="0"
                                            ...
                                            <tr>
                                                <td width="80%" valign="top">
                                                    <table width="67%" cellspacing="0" cellpadding="5"
                                                        class="course_reg" border="0">
                                                        <tr>
                                                            <td align="left" nowrap="nowrap"><strong>Student
                                                                    Name</strong></td>
                                                            <td align="left">
                                                                {{ $payment_data->surname . ' ' . $payment_data->first_name . ' ' . $payment_data->other_name }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td align="left" nowrap="nowrap"><strong> Date of
                                                                    Deposit</strong></td>
                                                            <td align="left">
                                                                {{ date('d M Y', strtotime($payment_data->updated_at)) }}
                                                            </td>
                                                        </tr>
                                                ...
                                                <td width="20%" valign="top">
                                                    <table width="150" height="143" border="0" align="center"
                                                        cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td height="143" align="center" valign="top"><img
                                                                    src="{{ asset('storage/' . $payment_data->profile_pix) }}"
                                                                    width="118" height="139" border="2" /></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    <td>
                                        <table width="95%" border="1" align="center" cellpadding="10"
                                            cellspacing="0" class="course_reg">
                                            <tr>
                                                <td width="10%" align="center" bgcolor="#0099CC"><strong>S/N</strong>
                                                </td>
                                                <td width="71%" bgcolor="#0099CC"><strong>Payment
