                ...
                <div class="col-lg-12 masonry-item">
                    ...
                    <div class="panel">
                        ...
                        <form id="courseRegForm" method="POST">
                                                    ...
                                                    <tr>
                                                        <td style="width: 50px;">
                                                            @if ($course->course_status == 'C')
                                                                <input type="checkbox"
                                                                    value="{{ $course->course_code . '_' . $course->course_title . '_' . $course->unit . '_' . $course->course_status . '_' . $course->course_id }}"
                                                        ...
                                                        <td>{{ $course->unit }}</td>
                                                        <td>@php echo $course->course_status == 'C' ? '<span class="badge badge-danger">' . $course->course_status . '</span>' : '<span class="badge badge-success">' . $course->course_status . '</span>'; @endphp
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                            ...
                            @if (count($courses) > 0)
                                <hr><button type="submit" id="btnSubmitRegForm"
